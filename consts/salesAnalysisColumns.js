export const salesAnalysisColumns1 = (dates, headers1, headers2) => {
    const dateColumns = [{
        //조회기간
        Header: "조회기간", columns: [{
            Header: "조회기간", rowspan: 2, columns: [{
                Header: "가맹점명", accessor: "chk_brand_name", headerStyle: {
        ...
        //대비기간
        {
            Header: "대비기간", columns: [{
                Header: "가맹점명", rowspan: 2, columns: [{
                    Header: "", accessor: "pre_brand_name", headerStyle: {
                        display: "none", textAlign: "center",
                    }, cellStyle: {
                        textAlign: "center",
                    }, // Cell: ({ value }) => value.toLocaleString(),
                ...
                ...dates.map((date) => ({
                    Header: date, columns: headers2.map((header, index) => ({
                        id: `${header.accessor}${date}`, Header: header.header,
