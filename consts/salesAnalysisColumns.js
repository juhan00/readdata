...
export const salesAnalysisColumns3 = (dates, headers1, startDate, endDate) => {
    const dateColumns = [{
        //조회기간
        Header: `조회기간 (${startDate} ~ ${endDate})`, columns: [
            {
                Header: "매출일자", rowspan: 2, columns: [{
                    Header: "", accessor: "chk_sale_date", headerStyle: {
                        display: "none", textAlign: "center",
                    }, cellStyle: {
                        textAlign: "center",
...
export const salesAnalysisColumns4 = (dates, headers1, startDate, endDate) => {
    const dateColumns = [{
        //조회기간
        Header: `대비기간 (${startDate} ~ ${endDate})`, columns: [
            {
